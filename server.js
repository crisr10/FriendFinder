...
//The first file will be the index html, this file will be constructed with bootstrap, I will also need to add a jquery link tag to handle all the requests between javascript and html files.

// The second html file will have a form that asks the user questions and stores this questions inside the app.
